package com.flycloud.mlayouthelper;
...
public class ViewHelper {
    ...
    /**
     * 使用名字查找与字段同名的视图
     * @param activity 查找目标活动对象
     * @param names 需查找的名字
     * @param action 找到后需进行的动作,参数一为匹配视图,参数二为匹配名字
     */
     ...
     * @param activity 查找目标活动对象
     * @param fields 需查找字段
     * @param action 找到后需进行的动作,参数一为匹配视图,参数二为匹配字段
     */
     ...
     * 给页中的视图赋值
     * @param activity 活动页
     * @param nameValue key为视图名字,value为需赋值的对象
